...
def main():
    ...
    st.markdown("---")
    st.markdown("**Welcome to your AI-powered study companion!** Generate intelligent quizzes on any topic.")
    st.markdown("---")
    ...
    topic = st.sidebar.text_input("Enter Topic" , placeholder="e.g., Python Programming, World History, Chemistry")
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown("💡 **Tip**: Be specific with your topic for better questions!")
    st.sidebar.markdown("Examples: 'Python Functions', 'World War II', 'Chemical Reactions'")
